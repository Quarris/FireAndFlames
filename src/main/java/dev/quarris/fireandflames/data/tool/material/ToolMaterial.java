...
public record ToolMaterial(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, Holder<ToolMaterial>> HOLDER_STREAM_CODEC = ByteBufCodecs.holderRegistry(RegistrySetup.Keys.MATERIALS);
