...
import dev.quarris.fireandflames.network.payload.CBMaterialConverterData;
...
public class PlayerEvents {
    ...
    public static void syncPlayerData(OnDatapackSyncEvent event) {
        var payload = new CBMaterialConverterData(DataMapUtil.getAllConverters(event.getPlayerList().getServer().registryAccess()));
