...
public abstract class CastingRecipe implements Recipe<CastingRecipe.Input> {
    ...
    protected CastingRecipe(Ingredient itemInput, int coolingTime, boolean consumeInput, boolean moveItem) {
    ...
    public abstract int requiredContents(FluidStack stack, Level level);
